...
public class UserAccountServiceImplTest {
    ...
    public void getUserAccountByUserIdTest() {
        Assertions.assertEquals(1L, userAccountService.getUserAccountByUserId(3L).getId());
    }
    ...
    public void withdrawMoneyFromAccountTest() {
        Assertions.assertEquals(BigDecimal.valueOf(50),
                userAccountService.withdrawMoneyFromAccount(3L, BigDecimal.valueOf(50)).getMoney());
    }

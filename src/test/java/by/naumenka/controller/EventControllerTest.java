...
public class EventControllerTest {
    ...
    @Before
    public void setUp() {
        event = new Event("title", new Date(11 - 8 - 2022));
    ...
    public void updateEventTest() throws Exception {
        Event eventForUpdate = new Event("titleUpdate", new Date(11 - 8 - 2022));
    ...
    public void getEventsForDayTest() throws Exception {
        ...
        mvc.perform(get("/events/getByDay/{day}", "11.08.2022"))
                .andExpect(status().isOk())
                .andExpect(view().name("eventPage"))
